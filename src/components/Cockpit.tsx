...
const Cockpit: FC<TelemetryProps> = ({
    ...
    return (
        /* SCREEN POSITION LAYER */
        <div className="fixed bottom-4 inset-x-0 z-[100] pointer-events-none font-mono flex justify-center md:justify-start md:left-10 md:inset-x-auto">

            {/* COCKPIT WIDTH FRAME (important — defines instrument size) */}
            <div className="w-[92%] max-w-[520px] md:w-auto">

                {/* TELEMETRY PANEL */}
                <div className="flex w-full justify-between md:flex-col gap-4 md:gap-6 bg-black/60 md:bg-transparent backdrop-blur-lg md:backdrop-blur-none px-5 py-3 md:p-0 rounded-full md:rounded-none border border-white/10 md:border-none">
                    ...
                    {regime && (
                        <div className="hidden md:block space-y-1 mb-2">
                            ...
                            <div className={`text-[10px] font-bold uppercase tracking-widest transition-all duration-300 ${
                                regime === 'OPTIMUM GROUND EFFECT'
                    ...
                    {/* SPEED */}
                    <div className="flex-1 min-w-0 text-center space-y-0 md:space-y-1">
                        <div className="text-[7px] md:text-[9px] text-white/30 uppercase tracking-[0.12em] md:tracking-[0.2em]">
                            Speed
                        </div>
                        <div className="flex items-baseline justify-center gap-1 md:gap-2">
                            ...
                            <span className="text-[8px] md:text-[10px] text-accent-blue uppercase font-bold tracking-widest">
                                KM/H
                            </span>
                        </div>
                    </div>
