...
const ModelSection: FC = () => {
    ...
    return (
        <section id="prototype-3d" className="min-h-screen bg-black flex flex-col p-4 md:p-20 items-center justify-center">
            {/* Header */}
            <div className="w-full max-w-[1200px] mb-8 md:mb-12 transition-all">
                <div className="flex items-center gap-4 mb-4">
                    <div className="w-2 h-2 rounded-full bg-accent-blue animate-pulse shadow-[0_0_15px_#00A3FF]" />
                    <div className="text-accent-blue font-mono text-[10px] md:text-[11px] tracking-[0.4em] md:tracking-[0.6em] uppercase opacity-70">Tactical Design Review // WIG-01</div>
                </div>
                <h2 className="text-4xl sm:text-6xl md:text-8xl font-black uppercase italic tracking-tighter leading-none m-0 text-white">
